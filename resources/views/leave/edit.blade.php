				...
				<form action="{{ url('leave/update') . '/' . $leave->id }}" method="POST">
					...
					<div class="mb-3">
						...
						<select class="form-select" aria-label="Default select example" id="start_time" name="start_time">
							...
							<option value="09:00" @if ($leave->start_time == '09:00') selected @endif>09:00 ~ 13:00</option>
							<option value="14:00" @if ($leave->start_time == '14:00') selected @endif>14:00 ~ 18:00</option>
						</select>
					...
					<div class="mb-3">
						...
						<select class="form-select" aria-label="Default select example" id="end_time" name="end_time">
							<option selected>Please select</option>
							<option value="13:00" @if ($leave->end_time == '13:00') selected @endif>09:00 ~ 13:00</option>
							<option value="18:00" @if ($leave->end_time == '18:00') selected @endif>14:00 ~ 18:00</option>
						</select>
					...
					<div class="mb-3 mt-3">
						...
						<select class="form-select" aria-label="Default select example" id="status" name="status">
							<option value="" @if ($leave->status == '') selected @endif>Please select</option>
							<option value="1" @if ($leave->status == '1') selected @endif>申請中</option>
							<option value="2" @if ($leave->status == '2') selected @endif>許可</option>
							<option value="3" @if ($leave->status == '3') selected @endif>拒絕</option>
						</select>
					...
					<div class="mb-3 mt-3">
						...
						<select class="form-select" aria-label="Default select example" id="type" name="type">
							<option value="" @if ($leave->type == '') selected @endif>Please select</option>
							<option value="1" @if ($leave->type == '1') selected @endif>特休</option>
							<option value="2" @if ($leave->type == '2') selected @endif>事假</option>
							<option value="3" @if ($leave->type == '3') selected @endif>病假</option>
						</select>
						@if ($errors->has('type'))
